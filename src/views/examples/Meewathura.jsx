...
class Meewathura extends React.Component {
          ...
          <Container  className="justify-content-center" fluid>
            <Row className="justify-content-center">
              <Col lg="12" md="12">
                ...
                <h1 className="text-white mt-0 mb-5 text-center"  >MEEWATHURA WATER TREATMENT PLANT</h1>
